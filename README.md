# BUA / GM 1227165 Step-111 ignition-shutdown lifecycle project
...
event at the software-powerdown endpoint. It
targets the 1986 Corvette L98 GM P4 ECM, service number 1227165, using the
...
See `docs/STEP111_IGNITION_SHUTDOWN_AUDIT.txt` for the listing-backed lifecycle
translation and HAL boundary. Earlier audit files remain as historical
checkpoints.
