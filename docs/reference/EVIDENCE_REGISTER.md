...
| SYS-020 | Confirmed after Step 171 | Step 122 concluded that no known reachable and internally defined firmware region remained unported. Step 167 identified diagnostic and factory LF880 exceptions; Steps 168-169 translated them, and Step 171 restored the qualified whole-image conclusion. | `bua-hac.lst`; Step-122 audit and addenda; Step-167 through Step-171 audits and regressions. |
...
| SYS-022 | Resolved by Steps 168-169 | Step 167 found LF880's factory table branch `$F88E-$F8B4` and diagnostic table branch `$F8CB-$F8ED` missing from the otherwise translated 160-baud manager. Steps 168 and 169 translate both branches and their emitted table semantics. | `bua-hac.lst`, `src/scheduler_serial.inc.h`, and Step-167/168/169 audits and regressions. |
